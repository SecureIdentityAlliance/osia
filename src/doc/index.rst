...
#. All persons recorded in CR have a UIN. The UIN can be used as a key to access person data for all records.
...
.. py:function:: verifyPersonAttributes(UIN, expressions)
    ...
    :return: A *Yes* if all expressions are true, a *No* if one expression is false, a *Unknown* if :todo:`Todo`
